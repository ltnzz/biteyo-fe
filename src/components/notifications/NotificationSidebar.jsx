      ...
      <div className="sticky top-[86px] space-y-4 pr-4">
                ...
                >
                  ...
                  <span
                    className={`rounded-full px-2 py-0.5 text-xs ${
                      isActive ? "bg-white text-pink-600" : "bg-gray-100 text-gray-500"
                    }`}
                  >
        ...
        <section className="rounded-2xl border border-gray-100 bg-white p-4">
          ...
          <div className="mt-3 grid gap-2 text-sm font-semibold">
            <Link to="/explore" className="rounded-xl px-3 py-2 text-gray-700 hover:bg-gray-50">
              Explore bites
            </Link>
            <Link to="/add" className="rounded-xl px-3 py-2 text-gray-700 hover:bg-gray-50">
              Post a bite
            </Link>
            <Link to="/profile" className="rounded-xl px-3 py-2 text-gray-700 hover:bg-gray-50">
              View profile
            </Link>
          </div>
        </section>
